...
public class MainUploadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference(Constants.DATABASE_PATH_UPLOADS_result);
    ...
    private void uploadFile(Uri data) {
        ...
        StorageReference sRef = mStorageReference.child(Constants.STORAGE_PATH_UPLOADS_result + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
